    ...
    <section id="contact" className="py-24 bg-secondary/20">
      <div className="mx-auto max-w-3xl px-6 lg:px-8">
        <div className="text-center space-y-6 mb-12">
          <h2 className="text-4xl font-bold tracking-tight text-balance">Join the vision revolution</h2>
          <p className="text-xl text-muted-foreground text-pretty leading-relaxed">
            We're seeking strategic partners and investors to bring SmartGlove to market. Schedule a demo to experience
        ...
        <div className="space-y-4">
          ...
          <p className="text-xs text-muted-foreground text-center">
            Institutional investors and strategic partners only. By submitting, you agree to our terms.
          </p>
        </div>
